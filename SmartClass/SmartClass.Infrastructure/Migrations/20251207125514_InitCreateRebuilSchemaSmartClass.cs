...
{
    /// <inheritdoc />
    public partial class InitCreateRebuilSchemaSmartClass : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeedbackHtml = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassMembers_ClassroomId_UserId",
                table: "ClassMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Materials_ClassroomId_Title",
                table: "Materials",
                columns: new[] { "ClassroomId", "Title" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_UserId_Token_IsRevoked",
                table: "RefreshTokens",
                columns: new[] { "UserId", "Token", "IsRevoked" });
